...
@Controller
@ViewScoped
@ManagedBean(name = "thirdStep")
public class ThirdStepController extends ContexController {

	public ThirdStepController() {
	}

	private static final Log LOG = LogFactory.getLog(ThirdStepController.class);
	...
	public String updateAccountContinue() {
		...
		try {
			user.getAccountInfo().setFirstStep(false);
