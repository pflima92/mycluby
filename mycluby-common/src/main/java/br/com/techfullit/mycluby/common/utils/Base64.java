...
public class Base64 {
	 ...
	 * @since 1.4
	 */
	public String encodeObject(java.io.Serializable serializableObject) throws java.io.IOException {
	 ...
	 * @since 2.0
	 */
	public String encodeObject(java.io.Serializable serializableObject, int options) throws java.io.IOException {
	 ...
	 * @since 1.5
	 */
	public Object decodeToObject(String encodedObject) throws java.io.IOException, java.lang.ClassNotFoundException {
	 ...
	 * @since 2.3.4
	 */
	public Object decodeToObject(String encodedObject, int options, final ClassLoader loader)
	 ...
	 * @since 2.1
	 */
	public void encodeToFile(byte[] dataToEncode, String filename) throws java.io.IOException {
	 ...
	 * @since 2.1
	 */
	public void decodeToFile(String dataToDecode, String filename) throws java.io.IOException {
	 ...
	 * @since 2.1
	 */
	public byte[] decodeFromFile(String filename) throws java.io.IOException {
	 ...
	 * @since 2.1
	 */
	public String encodeFromFile(String filename) throws java.io.IOException {
	 ...
	 * @since 2.2
	 */
	public void encodeFileToFile(String infile, String outfile) throws java.io.IOException {

		String encoded = new Base64().encodeFromFile(infile);
	 ...
	 * @since 2.2
	 */
	public void decodeFileToFile(String infile, String outfile) throws java.io.IOException {

		byte[] decoded = new Base64().decodeFromFile(infile);
		java.io.OutputStream out = null;
		try {
			out = new java.io.BufferedOutputStream(new java.io.FileOutputStream(outfile));
			out.write(decoded);
